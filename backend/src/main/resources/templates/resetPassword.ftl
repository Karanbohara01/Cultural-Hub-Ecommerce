    ...
    <tr>
        <td style="padding: 32px 48px 0 48px;">
            <div style="float: left; margin-left: 16px;">
                <p style="color:rgb(189, 9, 18); font-size: 16px; font-weight: 600; margin-bottom: 8px; margin-top: 8px;">Cultural-Hub</p>
                <p style="color:rgb(66, 93, 184); font-size: 14px; font-weight: 600; margin-top: 8px;">Ecommerce</p>
            </div>
        </td>
    </tr>
    <tr>
