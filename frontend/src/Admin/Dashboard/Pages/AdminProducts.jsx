...
export default function Product() {
    ...
    const handleSaveProduct = () => {
        ...
        axios
            .post('http://localhost:8787/add-products/save', fd, {
    ...
    const fetchProducts = async () => {
        try {
            const response = await axios.get('http://localhost:8787/add-products/getAll', {
                // Uncomment the next line if you need authorization headers
                headers: { Authorization: "Bearer " + localStorage.getItem("accessToken") }
            });
    ...
    const fetchProductById = async (id) => {
        try {
            const response = await axios.get(`http://localhost:8787/add-products/getById/${id}`, {
                // Uncomment the next line if you need authorization headers
                headers: { Authorization: "Bearer " + localStorage.getItem("accessToken") }
            });
    ...
    const handleRemoveProduct = (productId) => {
        ...
        axios
            .delete(`http://localhost:8787/add-products/delete/${productId}`)
            .then(() => {
    ...
    const handleUpdateProduct = () => {
        console.log('Product update data:', editProductData);
        console.log('Product ID:', editProductId);


        axios
            .put(`http://localhost:8787/add-products/update/${editProductId}`, editProductData)
            .then((response) => {
    ...
    console.log('Final check',editProductData);
