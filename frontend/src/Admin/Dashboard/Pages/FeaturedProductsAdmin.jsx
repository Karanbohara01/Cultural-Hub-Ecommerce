...
export default function FeaturedProductsAdmin() {
    ...
    const handleSaveProduct = () => {
        ...
        fd.append("brandName", productData?.productName);
        ...
        axios
            .post('http://localhost:8787/featured-products/save', fd, {
    ...
    const fetchProducts = async () => {
        try {
            const response = await axios.get('http://localhost:8787/featured-products/getAll', {
                // Uncomment the next line if you need authorization headers
                headers: { Authorization: "Bearer " + localStorage.getItem("accessToken") }
            });
    ...
    const fetchProductById = async (id) => {
        try {
            const response = await axios.get(`http://localhost:8787/featured-products/getById/${id}`, {
                // Uncomment the next line if you need authorization headers
                headers: { Authorization: "Bearer " + localStorage.getItem("accessToken") }
            });
    ...
    const handleRemoveProduct = (productId) => {
        ...
        axios
            .delete(`http://localhost:8787/featured-products/delete/${productId}`)
            .then(() => {
    ...
    const handleUpdateProduct = () => {
        ...
        console.log('Checking Data',editProductData);
        console.log('Checking Id',editProductId);


        axios
            .put(`http://localhost:8787/featured-products/update/${editProductId}`, editProductData,{
                // Uncomment the next line if you need authorization headers
                headers: { Authorization: "Bearer " + localStorage.getItem("accessToken") }
            })
            .then((response) => {
