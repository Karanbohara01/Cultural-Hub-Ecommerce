...
const Checkout = () => {
  ...
  const handlePay = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:8787/order/save", formData);
      // Handle success
      console.log("Response from backend:", response.data);
      // Handle success
      console.log("Response from backend:", response.data);
      toast.success(
          `Thank you for your purchase of  products. Your request has been received and is being processed.`
      );
      resetCart();
    } catch (error) {
      // Handle error
              ...
              <div className="col-md-6 p-2">
                ...
                <form className="row g-3 mb-3" onSubmit={handlePay}>
                  ...
                  <div className="col-12 mt-5">
                    <button id="button-linker" type="submit">
                      Proceed To Pay
                    </button>
                  </div>
                </form>
