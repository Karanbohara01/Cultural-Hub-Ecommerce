...
import Carousel from "../Admin/Dashboard/Components/Carousel.jsx";
        ...
        <div className="container-xxl">
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12">
              <div style={{marginTop:40}} className="d-flex flex-column justify-content-center ">
                <div style={{marginBottom:-550,zIndex:-300}}><Carousel/></div>
