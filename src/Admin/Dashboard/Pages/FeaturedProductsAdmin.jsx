...
export default function FeaturedProductsAdmin() {
    ...
    const handleSaveProduct = () => {
        ...
        axios
            .post('http://localhost:8787/admin/add-featured-products/save', fd, {
    ...
    const fetchProductById = async (id) => {
        try {
            const response = await axios.get(`http://localhost:8787/admin/add-featured-products/getById/${id}`, {
                // Uncomment the next line if you need authorization headers
                // headers: { Authorization: "Bearer " + localStorage.getItem("accessToken") }
            });
    ...
    const handleRemoveProduct = (productId) => {
        ...
        axios
            .delete(`http://localhost:8787/admin/add-featured-products/delete/${productId}`)
            .then(() => {
